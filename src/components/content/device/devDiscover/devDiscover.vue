...
import discoverNode from "./discover-node";
import discoverNet from "./discover-network";
import logSearch from "./log-search";
import groupMgmt from "./group-mgmt";
export default {
    name: "devDiscover",
    components: { logSearch, discoverNode, discoverNet, groupMgmt },
